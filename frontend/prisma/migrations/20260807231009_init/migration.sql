-- CreateEnum
CREATE TYPE "SourceType" AS ENUM ('UPLOAD', 'LINK');

-- CreateEnum
CREATE TYPE "SongStatus" AS ENUM ('UPLOADED', 'ANALYZING', 'ANALYZED', 'FAILED');
...
CREATE TABLE "Song" (
    ...
    "sourceUrl" TEXT,
    "status" "SongStatus" NOT NULL DEFAULT 'UPLOADED',
    "analysisData" JSONB,
    "analysisError" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
